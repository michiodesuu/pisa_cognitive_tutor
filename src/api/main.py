...
# CORS configuration - reads from environment variable CORS_ORIGINS
# Allows wildcard "*" (default) to open CORS for all origins, using regex to support allow_credentials=True.
